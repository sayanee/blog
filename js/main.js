(function () {
  ...
  var quotationList = [
    ...
    'It is the greatest of all mistakes to do nothing because you can only do little - do what you can.<br>~ Sydney Smith',
    ...
    'It is possible that your next frontier isn\'t to get more efficient. It is just to get more brave<br>~Seth Godin',
    ...
    'I don\'t wait for moods. You can accomplish nothing if you do that. You mind must know it has to get down to work.<br>~ Pearl S. Buck',
    ...
    'There is no passion to be found in settling for a life that is less than the one you are capable of living.<br>~ Nelson Mandela'
  ];
  var min = 0;
